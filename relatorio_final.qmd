...
Ao analisarmos a $\ref{fig-dispersao}$ observamos uma clara têndencia positiva entre as duas variáveis. Os pontos no gráfico (clientes), mostram que à medida que a altura aumenta, o peso tende a aumentar. A linha de regressão confirma essa associação positiva.   
